        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    cattleData.put("Id", txt_id);
                    cattleData.put("Name", txt_name);

                    // Push the cattleData Map to Firebase under the "cattle" node
                    DatabaseReference cattleRef =FirebaseDatabase.getInstance().getReference().child("cattle");cattleRef.push().setValue(cattleData, new DatabaseReference.CompletionListener() {
